...
const App = () => {
  ...
  return (
    <div className="app">
      <div className={`container-fluid fixed-top ${isScrolled ? 'shadow' : ''}`}>
        <div className={` ${isScrolled ? 'hide' : 'container topbar bg-primary d-none d-lg-block'}`}>
          <div className="d-flex justify-content-between">
            <div className="top-info ps-2">
              <small className="me-3"><i className="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#" className="text-white">B19-9 upper</a></small>
              <small className="me-3"><i className="fas fa-envelope me-2 text-secondary"></i><a href="#" className="text-white">atharvad2366@gmail.com</a></small>
            </div>
        ...
        <div className="container px-0">
          <nav className="navbar navbar-light bg-white navbar-expand-xl">
            <a href="index.html" className="navbar-brand">
              <h1 className="text-primary display-6">All in 1</h1>
            </a>
